...
export default function OurServices({ scrollY, viewportHeight }: OurServicesProps) {
    ...
    >
      ...
      >
        <div className="text-center">
          <SectionHeading
            title="Our Services"
            subtitle="From a simple cut to a full makeover, we've got you covered."
            variant="simple"
            align="center"
          />
        </div>
        ...
        <div className="grow p-2 flex justify-center">
          ...
          <div className="grow flex flex-col lg:justify-center lg:flex-row gap-(--wrapper-gap) lg:max-w-6xl">
            {serviceData.map((service, index) => {
              ...
              // Stagger effect for panels
              const panelDelay = isInViewport ? index * 0.08 : 0;
              ...
              return (
                ...
                >
                  ...
                  <Image
                    ...
                    fill
                    sizes="(max-width: 1023px) (100vw - 1rem), 512px"
                    className={`
                      -z-1 
                      object-cover 
                      ${expandedPanel === service.id ? "image-brightness" : "image-brightness-light"}`}
                  />
                  {/* Gradient overlay */}
