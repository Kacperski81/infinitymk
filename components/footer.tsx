        ...
        <footer id="footer" className={`${pathname === "/hair" || pathname === "/hair/" ? "mt-5" : "min-h-screen sm:py-10 md:py-2"} text-center flex items-center isolate xl:mt-8`}>
            ...
            <div className="container mx-auto py-2 px-4 w-full xl:max-w-7xl">
                <div className="space-y-2 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-6">
                    {/* Brand and contact */}
                    <div className="space-y-3 sm:col-span-2 xl:px-4 xl:col-span-1">
                        <h3 className="font-(family-name:--font-aboreto) text-xl sm:text-2xl font-semibold text-(--main-10)">Infinity MK</h3>
                        <p className="mb-2 text-sm lg:text-base leading-relaxed text-(--main-100)">Your premier destination for beauty, relaxation, and exceptional service.</p>
                    ...
                    <div className="space-y-3">
                        <h4 className="font-(family-name:--font-aboreto) text-base sm:text-xl font-semibold text-(--main-10)">Services</h4>
                    ...
                    <div className="space-y-4">
                        <h4 className="font-(family-name:--font-aboreto) text-base sm:text-xl font-semibold text-(--main-10)">Opening Hours</h4>
                        <div className="space-y-2 text-xs xl:text-base max-w-[200px] mx-auto">
                            <div className="flex justify-between gap-4">
                                <span className="text-(--main-200)">Monday</span>
                                <span className="text-(--main-50)">9:00 - 19:00</span>
                            </div>
                            <div className="flex justify-between gap-4">
                                <span className="text-(--main-200)">Tuesday</span>
                                <span className="text-(--main-50)">9:00 - 19:00</span>
                            </div>
                            <div className="flex justify-between gap-4">
                                <span className="text-(--main-200)">Wednesday</span>
                                <span className="text-(--main-50)">9:00 - 19:00</span>
                            </div>
                            <div className="flex justify-between gap-4">
                                <span className="text-(--main-200)">Thursday</span>
                                <span className="text-(--main-50)">9:00 - 19:00</span>
                            </div>
                            <div className="flex justify-between gap-4">
                                <span className="text-(--main-200)">Friday</span>
                                <span className="text-(--main-50)">9:00 - 19:00</span>
                            </div>
                            <div className="flex justify-between gap-4">
                                <span className="text-(--main-200)">Saturday</span>
                                <span className="text-(--main-50)">10:00 - 17:00</span>
                            </div>
                            <div className="flex justify-between gap-4">
                                <span className="text-(--main-200)">Sunday</span>
                                <span className="text-(--main-50)">10:00 - 17:00</span>
                            </div>
                        </div>
                    </div>
                    ...
                    {/* Social */}
                    <div className="space-y-3 sm:col-span-2 xl:col-span-3 2xl:col-span-1">
                        <h4 className="font-(family-name:--font-aboreto) text-base sm:text-xl font-semibold text-(--main-10)">Stay Connected</h4>
