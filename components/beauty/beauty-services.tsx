...
export default function BeautyServices() {
    ...
    return (
        <section className="isolate relative min-h-dvh xl:min-h-screen bg-(--main-400)/80 bg-[url(/beauty/beauty-services-bg.jpg)] bg-blend-multiply bg-bottom-left bg-cover bg-no-repeat flex justify-center xl:grid xl:grid-cols-12">
